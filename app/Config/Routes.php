...
// ==================== FRONT OFFICE ====================
// Pages publiques
// $routes->get('/regimes', 'FrontController::regimes');
// $routes->get('/regimes/categorie/(:any)', 'FrontController::regimesByCategory/$1');
// $routes->get('/regimes/detail/(:num)', 'FrontController::regimeDetail/$1');

// $routes->get('/sports', 'FrontController::sports');
// $routes->get('/sports/categorie/(:any)', 'FrontController::sportsByCategory/$1');
// $routes->get('/sports/detail/(:num)', 'FrontController::sportDetail/$1');

// $routes->get('/a-propos', 'FrontController::about');

...
<style>
    ...
    .fill-viande { background: #e74c3c; }
    .fill-poisson { background: #3498db; }
    .fill-volaille { background: #f39c12; }
    ...
    @media (max-width: 768px) {
        .regime-header h1 { font-size: 1.8rem; }
        .regime-body { padding: 20px; }
        .composition-bars { flex-direction: column; }
    }
</style>
        ...
        <div class="regime-body">
            ...
            <div class="price-section">
                ...
                <?php if(session()->has('user_id')): ?>
                    <form action="/wallet/acheter-regime" method="POST" id="achatForm">
                ...
                <?php else: ?>
                    <a href="/login" class="btn-acheter" style="display: inline-block; text-decoration: none;">
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="/regimes" class="btn-retour">
                    <i class="fas fa-arrow-left"></i> Retour aux régimes
                </a>
            </div>
        </div>
    </div>
